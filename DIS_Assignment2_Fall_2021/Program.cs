...
namespace DIS_Assignment2_Fall_2021
{
    class Program
    {
        ...
        */
        ...
        public static int LargestAltitude(int[] gain)
        {
            try
            {
                ...
                int[] altitude = new int[gain.Length + 1]; // {0,0,0,0,0,0};
        ...
        */
        ...
        public static List<string> CommonChars(string[] words)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 26; i++)
                    if (prim[i])
                    {
                        string try1 = ""+(char)(i + 97);
                        commonwords.Add(try1);
                    }
        ...
        public static bool UniqueOccurrences(int[] arr)
        {
            ...
            {
                //write your code here.
                var doCountMap = new Dictionary<int, int>();
                for (var i = 0; i < arr.Length; i++)
                {
                    if (doCountMap.ContainsKey(arr[i]))
                        doCountMap[arr[i]]++;
                    else
                        doCountMap.Add(arr[i], 1);
                }
                var hashSet = new HashSet<int>(doCountMap.Values);
                return hashSet.Count == doCountMap.Count;
            }
            catch (Exception)
            {
